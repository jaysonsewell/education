...
// To help you see what is in the variable/object
console.log(get)
...
if (guess == random) {
  ...
  // DOCUMENT.WRITE THAT THEY WON AND TELL THEM THE VALUE OF THE RANDOM NUMBER

} else {
	// Guess was incorrect

  // DOCUMENT.WRITE THAT THEY LOST AND TELL THEM THE VALUE OF THE RANDOM NUMBER
